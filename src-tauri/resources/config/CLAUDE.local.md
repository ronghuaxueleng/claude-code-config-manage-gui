...
创建或修改实体类、数据类、DTO、VO 等数据结构时，**必须**添加完整注释：

| # | 必须添加的注释 | 格式要求 |
|---|--------------|---------|
| 1 | 类注释 | 说明类的用途、业务含义 |
| 2 | 每个字段注释 | 说明字段含义、取值范围、单位等 |
| 3 | 枚举值注释 | 说明每个枚举值的含义 |

**适用语言：** Java、Python、TypeScript、Go、C#、Kotlin 等所有面向对象语言
 ...
 * 用于存储编排智能体的基本信息和配置参数
 */
public class NwGptAiAgentEntity {
    /**
     * 主键ID
     */
    private Long id;
